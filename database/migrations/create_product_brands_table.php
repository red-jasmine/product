...
return new class extends Migration {
    ...
    {
        Schema::create(config('red-jasmine-product.tables.prefix','jasmine_') . 'product_brands', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists(config('red-jasmine-product.tables.prefix','jasmine_') .'product_brands');
    }
};
